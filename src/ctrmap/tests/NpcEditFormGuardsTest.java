...
public class NpcEditFormGuardsTest {
	...
	static void removeKeepsModels(GARC zo, GARC gr) throws Exception {
		...
		NPCEditForm form = new NPCEditForm(LOADED, TOOLS, REDRAW, NAVI, CENTRE, SAVER, SAVER);
	...
	static void misnumberedUidsAskFirst(GARC zo) throws Exception {
		...
		try {
			new NPCEditForm(LOADED, TOOLS, REDRAW, NAVI, CENTRE, SAVER, SAVER).loadFromEntities(e, null);
		} finally {
			ctrmap.Ui.stopRecording();
		}
	...
	static void missingRegistryEntryAsksFirst(GARC zo) throws Exception {
		...
		try {
			new NPCEditForm(LOADED, TOOLS, REDRAW, NAVI, CENTRE, SAVER, SAVER).loadFromEntities(zone.entities, reg);
		} finally {
			ctrmap.Ui.stopRecording();
		}
